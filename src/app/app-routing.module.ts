...
import { ShowScheduledFlightsPassengerComponent } from './show-scheduled-flights-passenger/show-scheduled-flights-passenger.component';
...
const routes: Routes = [
  ...
  {path:'scheduledFlight/showForPassenger', component:ShowScheduledFlightsPassengerComponent},
...

  {
    ...
    canActivate:[AuthguardGuard, CustomerroleGuard]
  },
  {
    path:'admin',
